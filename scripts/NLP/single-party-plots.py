...
by_cycle_subjectivity = data[data["party"]=="Democratic Party"].groupby("election_cycle")["subjectivity"].mean()
by_cycle_polarity = data[data["party"]=="Democratic Party"].groupby("election_cycle")["polarity"].mean()
...
print(plt.xticks())
plt.savefig('../../plots/election_cycle_means_dem.png')
plt.show()
