...
by_cycle_subjectivity = data[data["speaker"] == "trump"].groupby("debate_date", sort = False)["subjectivity"].mean()
data["emotion"] = abs(data["polarity"])
by_cycle_polarity = data[data["speaker"] == "trump"].groupby("debate_date",  sort = False)["emotion"].mean()

print(by_cycle_polarity)
...
plt.title("Trump: Subjectivity and Non-Neutrality")
fig.tight_layout()  # otherwise the right y-label is slightly clipped
print(plt.xticks())
plt.savefig('../../plots/trump_emotion.png')
plt.show()
