...
by_cycle_polarity = data[data["speaker"] == "clinton"].groupby("debate_date", sort = False)["emotion"].mean()
...
plt.title("Hillary Clinton: Subjectivity and Non-Neutrality")
fig.tight_layout()  # otherwise the right y-label is slightly clipped
print(plt.xticks())
plt.savefig('../../plots/clinton_emotion.png')
plt.show()
